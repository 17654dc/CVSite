...
<aside>
    ...
    <article id="alignement_photo">
            ...
            <div>
                ...
                <p class="paragraphe"><a href="tel:+33786847627">07 86 84 76 27</a><br>
               <a href="mailto:david.claassen@free.fr">Contact email</a><br>
    ...
    <article>
        <div class="centre">
            <h2 class="titre">En quelques mots...</h2>
                <p class="paragraphe">Après 12 années de commercial, je me réoriente aujourd'hui vers ma formation initiale de développement Web, en intégrant la promotion 2019 de Référent Digital à la NFactory School du Campus Saint Marc de Rouen.</p>
                <p class="paragraphe">Celle-ci me permettra de mettre à jour mes connaissances en programmation et d'y ajouter une expertise en Community Management, afin de les combiner à mon expérience commerciale.<p>
        ...
        <div class="centre">
            <h3 class="titre">Compétences</h3>
                <div class="comp">
                    <img class="icone" src="assets/imgs/web.png" alt="Développement Web">
                    <img class="icone" src="assets/imgs/picture.png" size="20%" alt="Graphisme">
                    <img class="icone" src="assets/imgs/network.png" size="20%" alt="Community Management">
                </div>
                <div class="comp">
                    <p align="center" width="500px"><br>Développement Web &nbsp; &nbsp; &nbsp; <br><br> HTML, CSS, PHP, &nbsp; &nbsp; &nbsp;<br> Javascript &nbsp; &nbsp; &nbsp;</p>
                    <p align="center"><br>Graphisme<br><br> Photoshop<br>Illustrator<br>PAINT</p>
